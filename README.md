...
- [`CatalogLeafItemToCsv`](src/ExplorePackages.Worker.Logic/CatalogScan2/Drivers/CatalogLeafItemToCsv/CatalogLeafItemToCsvDriver.cs) - write all catalog leaf items to big CSVs for analysis
