...
namespace Knapcode.ExplorePackages
{
    ...
    public class CsvRecordGenerator : ISourceGenerator
    {
        ...
        private const string FullInterfaceName = "Knapcode.ExplorePackages.ICsvRecord";
        private const string FullKustoTypeAttributeName = "Knapcode.ExplorePackages.KustoTypeAttribute";

        private static readonly string AutoGenerated = "// <auto-generated />" + Environment.NewLine + Environment.NewLine;
        private static readonly string CsvRecordTemplate = AutoGenerated + @"using System;
using System.Collections.Generic;
using System.IO;
...
";
        ...
        private static readonly string KustoDDLTemplate = AutoGenerated + @"using System.Collections.Generic;
