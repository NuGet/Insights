...
{
    public class FindCatalogLeafItemsDriver : ICatalogScanDriver, ICsvCompactor<CatalogLeafItemRecord>
    {
        private readonly CatalogScanToCsvAdapter<CatalogLeafItemRecord> _adapter;
        private readonly CatalogClient _catalogClient;
        private readonly IOptions<ExplorePackagesWorkerSettings> _options;

        public FindCatalogLeafItemsDriver(
        ...
        public string ResultsContainerName => _options.Value.FindCatalogLeafItemsContainerName;
