...
']'",
        ...
        private static readonly bool PackageAssetAddTypeToDefaultTableName = AddTypeToDefaultTableName(typeof(Knapcode.ExplorePackages.Worker.PackageAssetToCsv.PackageAsset), PackageAssetDefaultTableName);

        private static readonly bool PackageAssetAddTypeToDDL = AddTypeToDDL(typeof(Knapcode.ExplorePackages.Worker.PackageAssetToCsv.PackageAsset), PackageAssetDDL);
    }
}
