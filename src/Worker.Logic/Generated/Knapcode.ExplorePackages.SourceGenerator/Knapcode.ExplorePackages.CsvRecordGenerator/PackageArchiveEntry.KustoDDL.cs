...
']'",
        ...
        private static readonly bool PackageArchiveEntryAddTypeToDefaultTableName = AddTypeToDefaultTableName(typeof(Knapcode.ExplorePackages.Worker.PackageArchiveToCsv.PackageArchiveEntry), PackageArchiveEntryDefaultTableName);

        private static readonly bool PackageArchiveEntryAddTypeToDDL = AddTypeToDDL(typeof(Knapcode.ExplorePackages.Worker.PackageArchiveToCsv.PackageArchiveEntry), PackageArchiveEntryDDL);
    }
}
