...
']'",
        ...
        private static readonly bool PackageVersionRecordAddTypeToDefaultTableName = AddTypeToDefaultTableName(typeof(Knapcode.ExplorePackages.Worker.PackageVersionToCsv.PackageVersionRecord), PackageVersionRecordDefaultTableName);

        private static readonly bool PackageVersionRecordAddTypeToDDL = AddTypeToDDL(typeof(Knapcode.ExplorePackages.Worker.PackageVersionToCsv.PackageVersionRecord), PackageVersionRecordDDL);
    }
}
