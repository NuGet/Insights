...
']'",
        ...
        private static readonly bool PackageSignatureAddTypeToDefaultTableName = AddTypeToDefaultTableName(typeof(Knapcode.ExplorePackages.Worker.PackageSignatureToCsv.PackageSignature), PackageSignatureDefaultTableName);

        private static readonly bool PackageSignatureAddTypeToDDL = AddTypeToDDL(typeof(Knapcode.ExplorePackages.Worker.PackageSignatureToCsv.PackageSignature), PackageSignatureDDL);
    }
}
