...
namespace NuGet.Insights.Worker.PackageCertificateToCsv
{
    ...
    */
    partial record PackageCertificate
    {
        public int FieldCount => 9;

        public void WriteHeader(TextWriter writer)
        {
            writer.WriteLine("ScanId,ScanTimestamp,LowerId,Identity,Id,Version,CatalogCommitTimestamp,Created,ResultType");
        }
