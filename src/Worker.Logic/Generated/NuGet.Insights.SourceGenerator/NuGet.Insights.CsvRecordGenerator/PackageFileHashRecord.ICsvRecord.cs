...
namespace NuGet.Insights.Worker.PackageFileHashToCsv
{
    /* Kusto DDL:

    .drop table PackageFileHashes ifexists;

    .create table PackageFileHashes (
        LowerId: string,
        Identity: string,
        Id: string,
        Version: string,
        ...
        SHA512: string,
        First64: string
    ) with (docstring = "See https://github.com/NuGet/Insights/blob/main/docs/tables/PackageFileHashes.md", folder = "");

    .alter-merge table PackageFileHashes policy retention softdelete = 30d;

    .alter table PackageFileHashes policy partitioning '{'
      '"PartitionKeys": ['
        '{'
          '"ColumnName": "Identity",'
          '"Kind": "Hash",'
    ...
    .create table PackageFileHashes ingestion csv mapping 'BlobStorageMapping'
    '['
    ...
    */
    partial record PackageFileHashRecord
    {
        ...
        {
            return new PackageFileHashRecord
            {
