    ...
    partial record PackageManifestRecord
    {
        ...
        public static PackageManifestRecord ReadNew(Func<string> getNextField)
        {
            return new PackageManifestRecord
            {
                ...
                DevelopmentDependency = CsvUtility.ParseNullable(getNextField(), bool.Parse),
                IsServiceable = CsvUtility.ParseNullable(getNextField(), bool.Parse),
                ...
                RequireLicenseAcceptance = CsvUtility.ParseNullable(getNextField(), bool.Parse),
                ...
                ContentFilesHasFormatException = CsvUtility.ParseNullable(getNextField(), bool.Parse),
                DependencyGroupsHasMissingId = CsvUtility.ParseNullable(getNextField(), bool.Parse),
