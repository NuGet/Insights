...
namespace NuGet.Insights
{
    ...
    {
        public const string SymbolPackageFileHashRecordDefaultTableName = "SymbolPackageFileHashes";

        public static readonly IReadOnlyList<string> SymbolPackageFileHashRecordDDL = new[]
        {
...
']'",
        ...
        public const string SymbolPackageFileHashRecordPartitioningPolicy = @".alter table __TABLENAME__ policy partitioning '{'
  '""PartitionKeys"": ['
    '{'
      '""ColumnName"": ""Identity"",'
      '""Kind"": ""Hash"",'
...
'}'";
        ...
        private static readonly bool SymbolPackageFileHashRecordAddTypeToDefaultTableName = AddTypeToDefaultTableName(typeof(NuGet.Insights.Worker.SymbolPackageFileHashToCsv.SymbolPackageFileHashRecord), SymbolPackageFileHashRecordDefaultTableName);

        private static readonly bool SymbolPackageFileHashRecordAddTypeToDDL = AddTypeToDDL(typeof(NuGet.Insights.Worker.SymbolPackageFileHashToCsv.SymbolPackageFileHashRecord), SymbolPackageFileHashRecordDDL);

        private static readonly bool SymbolPackageFileHashRecordAddTypeToPartitioningPolicy = AddTypeToPartitioningPolicy(typeof(NuGet.Insights.Worker.SymbolPackageFileHashToCsv.SymbolPackageFileHashRecord), SymbolPackageFileHashRecordPartitioningPolicy);
    }
}
