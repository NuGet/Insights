...
namespace NuGet.Insights.Worker.PackageArchiveToCsv
{
    ...
    .create table PackageArchiveEntries (
        ...
        Comment: string
    ) with (docstring = "See https://github.com/NuGet/Insights/blob/main/docs/tables/PackageArchiveEntries.md", folder = "");
    ...
    */
    partial record PackageArchiveEntry
    {
        ...
        public static PackageArchiveEntry ReadNew(Func<string> getNextField)
        {
