...
namespace NuGet.Insights.Worker.SymbolPackageArchiveToCsv
{
    ...
    {
        public class SymbolPackageArchiveEntryMessagePackFormatter : IMessagePackFormatter<SymbolPackageArchiveEntry>
        {
            public void Serialize(ref MessagePackWriter writer, SymbolPackageArchiveEntry value, MessagePackSerializerOptions options)
            {
                if (value is null)
                {
                    writer.WriteNil();
            ...
            public SymbolPackageArchiveEntry Deserialize(ref MessagePackReader reader, MessagePackSerializerOptions options)
            {
                ...
                var record = new SymbolPackageArchiveEntry();
