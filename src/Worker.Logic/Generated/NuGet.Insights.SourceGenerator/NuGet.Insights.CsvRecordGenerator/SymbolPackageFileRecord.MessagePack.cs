...
namespace NuGet.Insights.Worker.SymbolPackageFileToCsv
{
    ...
    {
        public class SymbolPackageFileRecordMessagePackFormatter : IMessagePackFormatter<SymbolPackageFileRecord>
        {
            public void Serialize(ref MessagePackWriter writer, SymbolPackageFileRecord value, MessagePackSerializerOptions options)
            {
                if (value is null)
                {
                    writer.WriteNil();
            ...
            public SymbolPackageFileRecord Deserialize(ref MessagePackReader reader, MessagePackSerializerOptions options)
            {
                ...
                var record = new SymbolPackageFileRecord();
