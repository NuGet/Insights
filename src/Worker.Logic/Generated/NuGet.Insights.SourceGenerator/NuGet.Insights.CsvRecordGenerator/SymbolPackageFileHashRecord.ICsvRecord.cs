...
namespace NuGet.Insights.Worker.SymbolPackageFileHashToCsv
{
    /* Kusto DDL:

    .drop table SymbolPackageFileHashes ifexists;

    .create table SymbolPackageFileHashes (
        LowerId: string,
        Identity: string,
        Id: string,
        Version: string,
        ...
        SHA512: string,
        First64: string
    ) with (docstring = "See https://github.com/NuGet/Insights/blob/main/docs/tables/SymbolPackageFileHashes.md", folder = "");

    .alter-merge table SymbolPackageFileHashes policy retention softdelete = 30d;

    .alter table SymbolPackageFileHashes policy partitioning '{'
      '"PartitionKeys": ['
        '{'
          '"ColumnName": "Identity",'
          '"Kind": "Hash",'
    ...
    .create table SymbolPackageFileHashes ingestion csv mapping 'BlobStorageMapping'
    '['
    ...
    */
    partial record SymbolPackageFileHashRecord
    {
        ...
        {
            return new SymbolPackageFileHashRecord
            {
