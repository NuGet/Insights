...
namespace NuGet.Insights.Worker.SymbolPackageArchiveToCsv
{
    ...
    */
    partial record SymbolPackageArchiveRecord
    {
        ...
        public static SymbolPackageArchiveRecord ReadNew(Func<string> getNextField)
        {
            return new SymbolPackageArchiveRecord
            {
                ...
                Size = CsvUtility.ParseNullable(getNextField(), long.Parse),
                OffsetAfterEndOfCentralDirectory = CsvUtility.ParseNullable(getNextField(), long.Parse),
                CentralDirectorySize = CsvUtility.ParseNullable(getNextField(), uint.Parse),
                OffsetOfCentralDirectory = CsvUtility.ParseNullable(getNextField(), uint.Parse),
                EntryCount = CsvUtility.ParseNullable(getNextField(), int.Parse),
