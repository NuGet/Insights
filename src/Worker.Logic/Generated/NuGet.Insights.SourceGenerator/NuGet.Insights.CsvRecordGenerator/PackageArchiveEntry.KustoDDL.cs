...
']'",
        ...
        public const string PackageArchiveEntryPartitioningPolicy = @".alter table __TABLENAME__ policy partitioning '{'
  '""PartitionKeys"": ['
    '{'
      '""ColumnName"": ""Identity"",'
      '""Kind"": ""Hash"",'
...
'}'";
        ...
        private static readonly bool PackageArchiveEntryAddTypeToPartitioningPolicy = AddTypeToPartitioningPolicy(typeof(NuGet.Insights.Worker.PackageArchiveToCsv.PackageArchiveEntry), PackageArchiveEntryPartitioningPolicy);
    }
}
