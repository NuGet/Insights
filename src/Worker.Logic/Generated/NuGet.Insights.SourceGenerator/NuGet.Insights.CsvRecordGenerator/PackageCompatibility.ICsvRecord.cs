...
namespace NuGet.Insights.Worker.PackageCompatibilityToCsv
{
    ...
    */
    partial record PackageCompatibility
    {
        ...
        public static PackageCompatibility ReadNew(Func<string> getNextField)
        {
            return new PackageCompatibility
            {
                ...
                HasError = CsvUtility.ParseNullable(getNextField(), bool.Parse),
                DoesNotRoundTrip = CsvUtility.ParseNullable(getNextField(), bool.Parse),
                HasAny = CsvUtility.ParseNullable(getNextField(), bool.Parse),
                HasUnsupported = CsvUtility.ParseNullable(getNextField(), bool.Parse),
                HasAgnostic = CsvUtility.ParseNullable(getNextField(), bool.Parse),
