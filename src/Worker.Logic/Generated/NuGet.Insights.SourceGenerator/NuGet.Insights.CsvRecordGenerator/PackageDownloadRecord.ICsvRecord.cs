...
namespace NuGet.Insights.Worker.DownloadsToCsv
{
    ...
    .drop table PackageDownloads ifexists;
    ...
    .create table PackageDownloads (
        ...
        Downloads: long,
        TotalDownloads: long
    ) with (docstring = "See https://github.com/NuGet/Insights/blob/main/docs/tables/PackageDownloads.md", folder = "");

    .alter-merge table PackageDownloads policy retention softdelete = 30d;

    .alter table PackageDownloads policy partitioning '{'
      '"PartitionKeys": ['
        '{'
          '"ColumnName": "Identity",'
          '"Kind": "Hash",'
    ...
    */
    partial record PackageDownloadRecord
    {
        ...
        public static PackageDownloadRecord ReadNew(Func<string> getNextField)
        {
