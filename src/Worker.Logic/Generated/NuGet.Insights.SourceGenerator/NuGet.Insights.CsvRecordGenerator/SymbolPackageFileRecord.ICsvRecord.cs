...
namespace NuGet.Insights.Worker.SymbolPackageFileToCsv
{
    ...
    .drop table SymbolPackageFiles ifexists;

    .create table SymbolPackageFiles (
        LowerId: string,
        Identity: string,
        Id: string,
        Version: string,
    ...
    .alter table SymbolPackageFiles policy partitioning '{'
      '"PartitionKeys": ['
        '{'
          '"ColumnName": "Identity",'
          '"Kind": "Hash",'
    ...
    .create table SymbolPackageFiles ingestion csv mapping 'BlobStorageMapping'
    '['
    ...
    */
    partial record SymbolPackageFileRecord
    {
        ...
        public static SymbolPackageFileRecord ReadNew(Func<string> getNextField)
        {
            return new SymbolPackageFileRecord
            {
