...
param customScriptExtensionFileDirectory string
        ...
        extensions: [
          {
            ...
            properties: {
              ...
              settings: {
                ...
                commandToExecute: 'powershell -ExecutionPolicy Unrestricted -File "${customScriptExtensionFileDirectory}Install-WorkerStandalone.ps1" -DeploymentLabel "${deploymentLabel}" -ApplicationInsightsConnectionString "${appInsights.properties.ConnectionString}" -UserManagedIdentityClientId "${userManagedIdentity.properties.clientId}" -RoleName "${vmssName}" -ExpandOSPartition'
              }
              protectedSettings: {
                managedIdentity: {
