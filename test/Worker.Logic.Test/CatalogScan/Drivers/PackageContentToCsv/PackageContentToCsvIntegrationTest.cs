...
namespace NuGet.Insights.Worker.PackageContentToCsv
{
    public class PackageContentToCsvIntegrationTest : BaseCatalogLeafScanToCsvIntegrationTest<PackageContent>
    {
        ...
        public class PackageContentToCsv : PackageContentToCsvIntegrationTest
        {
            public PackageContentToCsv(ITestOutputHelper output, DefaultWebApplicationFactory<StaticFilesStartup> factory)
                : base(output, factory)
            {
            }
        ...
        public class PackageContentToCsv_WithDelete : PackageContentToCsvIntegrationTest
        {
            public PackageContentToCsv_WithDelete(ITestOutputHelper output, DefaultWebApplicationFactory<StaticFilesStartup> factory)
                : base(output, factory)
            {
            }
