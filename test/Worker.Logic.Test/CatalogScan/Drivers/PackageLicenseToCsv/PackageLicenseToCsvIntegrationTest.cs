...
namespace NuGet.Insights.Worker.PackageLicenseToCsv
{
    public class PackageLicenseToCsvIntegrationTest : BaseCatalogLeafScanToCsvIntegrationTest<PackageLicense>
    {
        ...
        public class PackageLicenseToCsv : PackageLicenseToCsvIntegrationTest
        {
            public PackageLicenseToCsv(ITestOutputHelper output, DefaultWebApplicationFactory<StaticFilesStartup> factory)
                : base(output, factory)
            {
            }
        ...
        public class PackageLicenseToCsv_WithDelete : PackageLicenseToCsvIntegrationTest
        {
            public PackageLicenseToCsv_WithDelete(ITestOutputHelper output, DefaultWebApplicationFactory<StaticFilesStartup> factory)
                : base(output, factory)
            {
            }
