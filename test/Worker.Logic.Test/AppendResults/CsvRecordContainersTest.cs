...
namespace NuGet.Insights.Worker
{
    public class CsvRecordContainersTest : BaseWorkerLogicIntegrationTest
    {
        ...
        public void AuxiliaryRecordTypesAreIAggregatedRecord(Type recordType)
        {
            ...
            Assert.False(recordType.IsAssignableTo(typeof(IAggregatedCsvRecord<>).MakeGenericType(recordType)));
        }
        ...
        {
            return recordType.GetProperty(nameof(IAggregatedCsvRecord<IAggregatedCsvRecord>.KeyComparer)).GetValue(null);
        }

        private static IReadOnlyList<string> GetKeyFields(Type recordType)
        {
            return (IReadOnlyList<string>)recordType.GetProperty(nameof(IAggregatedCsvRecord<IAggregatedCsvRecord>.KeyFields)).GetValue(null);
        }
