...
| [GitHubUsages](GitHubUsages.md)                               | Package ID references on popular GitHub repositories                          |
...
| [PackageFiles](PackageFiles.md)                               | Basic information (such as hash) of every file in the package .nupkg          |
...
| [PopularityTransfers](PopularityTransfers.md)                 | Popularity transfers for a give package ID, if any                            |
...
| [SymbolPackageFiles](SymbolPackageFiles.md)                   | Basic information (such as hash) of every file in the package .snupkg         |
