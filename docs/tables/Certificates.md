...
| Column used for CSV partitioning   | Fingerprint                                                                                        |
| Column used for Kusto partitioning | Fingerprint                                                                                        |
...
| Record type                        | [`CertificateRecord`](../../src/Worker.Logic/Drivers/PackageCertificateToCsv/CertificateRecord.cs) |
