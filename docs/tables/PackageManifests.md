...
| Owners                         | string           | No                   | Freeform owner names, not the same as [NuGet.org owners](PackagesOwners.md), [docs](https://docs.microsoft.com/en-us/nuget/reference/nuspec#owners) |
