...
| NuGetGallery           | array of strings | Yes, for Available unless HasError | Frameworks via same logic a NuGetGallery, with URL-encoded paths decoded |
| NuGetGalleryEscaped    | array of strings | Yes, for Available unless HasError | Frameworks via same logic a NuGetGallery, with URL-encoded left encoded  |
